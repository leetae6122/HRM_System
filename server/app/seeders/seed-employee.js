...
module.exports = {
    up: async (queryInterface, Sequelize) => {
        await queryInterface.bulkInsert('Employee', [{
            ...
            gender: true,
            dateBirth: '1995-03-16',
            citizenshipId: '012199503160',
        ...
        },
        {
            ...
            phoneNumber: '0723223420',
            gender: true,
            dateBirth: '1996-02-18',
            citizenshipId: '012199602180',
        ...
        },
        {
            ...
            gender: false,
            dateBirth: '1997-10-14',
            citizenshipId:'012199710142',
